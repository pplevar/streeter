    ...
    Scaffold { paddingValues ->
        Column(
            ...
            Button(
                ...
                Text(
                    text = if (isActiveWalk) stringResource(R.string.label_resume_walk)
                    else stringResource(R.string.label_start_walk),
    ...
    Card(
        ...
        Column(
            ...
            Row(
                ...
                fun statText(number: String, label: String) = buildAnnotatedString {
