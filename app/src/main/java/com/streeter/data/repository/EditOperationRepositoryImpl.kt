...
class EditOperationRepositoryImpl @Inject constructor(
    ...
    override suspend fun getOperationsForWalk(walkId: Long): List<EditOperation> =
        dao.getOperationsForWalk(walkId).map {
            EditOperation(it.id, it.walkId, it.operationOrder,
    ...
    override suspend fun deleteLastOperation(walkId: Long) =
        dao.deleteLastOperation(walkId)

    override suspend fun deleteAllOperationsForWalk(walkId: Long) =
        dao.deleteAllForWalk(walkId)
}
