    ...
    constructor(
        ...
        override suspend fun matchTrace(points: List<GpsPoint>): Result<MatchResult> {
            ...
            return withContext(Dispatchers.IO) {
                try {
                    ...
                    val geometry = TraceGeometry.lineStringFeature(matchResult.mergedPath.calcPoints().toLatLngs())
                    Result.success(
                        MatchResult(
        ...
        private fun routeSegment(
            ...
            return try {
                ...
                val geometry = TraceGeometry.lineStringFeature(best.points.toLatLngs())
        ...
        private fun mergeRouteResults(results: List<RouteResult>): Result<RouteResult> {
            ...
            for ((i, result) in results.withIndex()) {
                ...
                if (i == 0) {
                    ...
                    allCoords.addAll(coords.drop(1)) // first point duplicates previous segment's last
                }
            }
