...
fun StreetEntity.toDomain() = Street(
    id = id, osmWayId = osmWayId, name = name,
    cityTotalLengthM = cityTotalLengthM,
    osmDataVersion = osmDataVersion, osmNameHash = osmNameHash
)
...
fun StreetSectionEntity.toDomain() = StreetSection(
    id = id, streetId = streetId, fromNodeOsmId = fromNodeOsmId,
    toNodeOsmId = toNodeOsmId, lengthM = lengthM, geometryJson = geometryJson,
    stableId = stableId, isOrphaned = isOrphaned
)

fun StreetSection.toEntity() = StreetSectionEntity(
    id = id, streetId = streetId, fromNodeOsmId = fromNodeOsmId,
    toNodeOsmId = toNodeOsmId, lengthM = lengthM, geometryJson = geometryJson,
    stableId = stableId, isOrphaned = isOrphaned
)
