...
class StreetCoverageEngineTest {
    ...
    private fun streetCoverage(sections: List<StreetSection>, coverages: Map<String, Float>): Float {
    ...
    private fun generateStableId(streetName: String, fromNodeId: Long, toNodeId: Long): String {
